...
contract PVTSD is SecondaryCrowdsaleContract {
    ...
    uint256 public minPurchase = 500000; // 50,00.00 USD in cents
    ...
    constructor(
        ...
        // Set Total Supply
        totalSupply = 1000 * 100000 * decimalMultiplier;
        ...
        // Token release date 12 months post end date
    ...
    function buyTokens() payable public {
        ...
        uint256 discountedExchangeRate = exchangeRate.mul(80).div(100);
